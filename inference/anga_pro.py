...
class AngaProInference:
    """
    Run the bridge models on ERA5 forecast features to produce all 51
    ...
    def _load_bridges(self):
        ...
        logger.info(f"Loading bridge models for {self.region} from S3...")
    ...
    def predict(self, era5_df: pd.DataFrame) -> pd.DataFrame:
        """
        Run bridge models on a DataFrame of ERA5 forecast features.
