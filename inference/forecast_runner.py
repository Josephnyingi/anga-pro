...
Loads historical data from S3, runs bridge models on SEAS5 forecast input,
...
from inference.anga_pro import AngaProInference
...
def run_region_forecast(
    ...
    """
    Run the bridge models + drought model for a single region.
    ...
    # Run bridge models
    bridge = AngaProInference(region)
