...
Maps ECMWF SEAS5 GRIB variables to ERA5_CORE_FEATURES for bridge model input.
...
def seas5_to_era5_features(
    ...
    Returns:
        DataFrame with ERA5_CORE_FEATURES columns ready for the bridge models.
    """
    from inference.anga_pro import ERA5_CORE_FEATURES
...
def load_and_convert(
    ...
    Returns:
        DataFrame with ERA5_CORE_FEATURES ready for the bridge models.
    """
    forecast_path = _download_grib_from_s3(forecast_s3_key)
    clim_path = _download_grib_from_s3(climatology_s3_key)
