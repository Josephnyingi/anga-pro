...
## Anga Pro: Drought Forecasts Beyond the Satellite Horizon
...
### The Solution
Anga Pro trains XGBoost regressors on 35 years of satellite history to synthesize what the satellites *would* see, given only an atmospheric weather forecast:
